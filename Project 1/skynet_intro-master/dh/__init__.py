...
# 4096bit safe prime for Diffie-Hellman key exchange
...
def create_dh_key():
    ...
    # get random my_private_key 2 < g < prime-1
    my_private_key = random.randint(2, prime - 1)
    # calculate (g^m) mod prime
    my_public_key = pow(generator, my_private_key, prime)
